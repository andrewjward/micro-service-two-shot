...
function HatsList() {
    ...
    return (
      <main>
    <a href= "/hats/new/">
        <button className="btn btn-success" type="submit">Create new Hat</button>
    </a>
          ...
          {hats.map(hat => {
            return (
              <tr key={hat.href}>
                ...
                <td>
                    <button type="button" className="btn btn-danger" onClick={() => handleDelete(hat.id)}>Delete</button>
                </td>
              </tr>
            );
          })}
